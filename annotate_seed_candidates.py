...
def print_instructions() -> None:
    ...
    print()
    print("Please judge semantics, not surface details:")
    print("  - mark true if the target is overall a correct semantic translation")
    print("  - ignore capitalization and clear OCR/spelling errors")
    print("  - ignore inflectional differences: tense, singular/plural, gender,")
    print("    and grammatical case such as nominative, accusative, dative, or genitive")
    print("  - mark false if either word is in the wrong language for its column")
    print("  - mark false if the two words are identical")
    print()
    print("For words with multiple meanings, judge the most common meaning of each word.")
    print("Mark true if the common meanings match.")
    print("Mark false if the match only works through a rare or unusual meaning.")
    print()
